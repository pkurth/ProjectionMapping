...
ConstantBuffer<hierarchical_depth_cb> cb			: register(b0);

RWTexture2D<float> outputMip1						: register(u0); // Half size of input.
RWTexture2D<float> outputMip2						: register(u1);
RWTexture2D<float> outputMip3						: register(u2);
RWTexture2D<float> outputMip4						: register(u3);
RWTexture2D<float> outputMip5						: register(u4);
...
[RootSignature(HIERARCHICAL_DEPTH_RS)]
