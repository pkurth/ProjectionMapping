...
struct dx_window : win32_window
{
	...
	bool initialize(const TCHAR* name, uint32 initialWidth, uint32 initialHeight, color_depth colorDepth = color_depth_8, bool exclusiveFullscreen = false, bool disableResizing = false);
