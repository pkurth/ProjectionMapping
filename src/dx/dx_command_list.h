...
struct dx_command_list
{
	...
	void copyBufferRegionToBuffer(const ref<dx_buffer>& from, const ref<dx_buffer>& to, uint32 sourceElementOffset, uint32 targetElementOffset, uint32 elementCount);
